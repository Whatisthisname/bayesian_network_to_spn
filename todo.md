...
- use something a-la interior points method to prevent density from over-optimizing and "walking" away from samples
- param_to_clg conversion in nb_CLG.ipynb

## **report structure first draft**
...
\\&
\hspace{40px}\text{for  } \theta(a,b) := (b-a) \cdot p_X(\frac{a+b}{2})
\\&
\hspace{40px}\text{and  } \text{Leaf}(y, a, b) := p_{Y|X}\left(y\;|\;X=\frac{a+b}{2}\right)
\end{align*}
$$
